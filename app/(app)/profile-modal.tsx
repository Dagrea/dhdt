...
import { capitalizeFirstCharacter, clearHistory, formatDate, formatPhoneNumber, storageUtil } from '@utils';
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            storageUtil.deleteItem('patient_id');
            storageUtil.deleteItem('push_token');
            queryClient.clear();
